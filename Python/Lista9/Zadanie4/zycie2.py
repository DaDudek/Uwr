...
def walcz(tab,y,x,ys,xs):
	if tab[y][x][1]>1 and tab[ys][xs][0]==".": #cos vs pusty
		kopia_tablicy[ys][xs]=[kopia_tablicy[y][x][0],kopia_tablicy[y][x][1]-1]

	if tab[y][x][0]=="k" and tab[ys][xs][0]=="p": #kamien vs papier
		if tab[y][x][1]==1:
			kopia_tablicy[y][x]=[".",0]
		if tab[y][x][1]>1:
			sila_przegranego=kopia_tablicy[y][x][1]
			kopia_tablicy[y][x]=["k",sila_przegranego-1]
		if tab[ys][xs][1]<5:
				sila_wygranego=kopia_tablicy[ys][xs][1]
				kopia_tablicy[ys][xs]=["p",sila_wygranego+1]
		

	if tab[y][x][0]=="k" and tab[ys][xs][0]=="n": #kamien vs nozyce
		if tab[ys][xs]==1:
			kopia_tablicy[ys][xs]=[".",0]
		if tab[ys][xs][1]>1:
			tmp=kopia_tablicy[ys][xs][1]
			kopia_tablicy[ys][xs]=["n",tmp-1]
		if tab[y][x][1]<5:
				sila_wygranego=kopia_tablicy[y][x][1]
				kopia_tablicy[y][x]=["k",sila_wygranego+1]
	...
	if tab[y][x][0]=="p" and tab[ys][xs][0]=="k": #papier vs kamien
		...
		if tab[ys][xs][1]>1:
			tmp=kopia_tablicy[ys][xs][1]
			kopia_tablicy[ys][xs]=["k",tmp-1]
		if tab[y][x][1]<5:
				sila_wygranego=kopia_tablicy[y][x][1]
				kopia_tablicy[y][x]=["p",sila_wygranego+1]

	if tab[y][x][0]=="p" and tab[ys][xs][0]=="n": #papier vs nozyce 
		if tab[y][x]==1:
			kopia_tablicy[y][x]=[".",0]
		if tab[y][x][1]>1:
			tmp=kopia_tablicy[y][x][1]
			kopia_tablicy[y][x]=["p",tmp-1]
		if tab[ys][xs][1]<5:
			sila_wygranego=kopia_tablicy[ys][xs][1]
			kopia_tablicy[ys][xs]=["n",sila_wygranego+1]
	...
	if tab[y][x][0]=="n" and tab[ys][xs][0]=="p":#nozyce vs papier
		...
		if tab[ys][xs][1]>1:
			tmp=kopia_tablicy[ys][xs][1]
			kopia_tablicy[ys][xs]=["p",tmp-1]
		if tab[y][x][1]<5:
			sila_wygranego=kopia_tablicy[y][x][1]
			kopia_tablicy[y][x]=["n",sila_wygranego+1]
	...
	if tab[y][x][0]=="n" and tab[ys][xs][0]=="k":#nozyce vs kamien
		...
		if tab[y][x][1]>1:
			tmp=kopia_tablicy[y][x][1]
			kopia_tablicy[y][x]=["n",tmp-1]
		if tab[ys][xs][1]<5:
			sila_wygranego=kopia_tablicy[ys][xs][1]
			kopia_tablicy[ys][xs]=["k",sila_wygranego+1]
